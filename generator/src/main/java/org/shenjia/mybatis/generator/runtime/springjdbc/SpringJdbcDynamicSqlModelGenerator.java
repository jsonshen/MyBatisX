...
public class SpringJdbcDynamicSqlModelGenerator extends AbstractJavaGenerator {
	...
	public List<CompilationUnit> getCompilationUnits() {
		...
		for (IntrospectedColumn col : columns) {
			...
			Field field = getJavaBeansFieldWithGeneratedAnnotation(col, context, introspectedTable, modelClass);
			...
			Method method = getJavaBeansGetterWithGeneratedAnnotation(col, context, introspectedTable, modelClass);
			...
			if (!introspectedTable.isImmutable()) {
				method = getJavaBeansSetterWithGeneratedAnnotation(col, context, introspectedTable, modelClass);
	...
	private void addJdbcModelInterface(TopLevelClass modelClass) {
		...
		modelClass.addSuperInterface(new FullyQualifiedJavaType("JdbcModel<" + modelClass.getType().getShortName() + ">"));
	...
	private void addRowMapperMethod(TopLevelClass modelClass) {
		...
		context.getCommentGenerator()
		    .addGeneralMethodAnnotation(method, introspectedTable, modelClass.getImportedTypes());
