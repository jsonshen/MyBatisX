...
public class UpdateByPrimaryKeyMethodGenerator extends AbstractMethodGenerator {
    ...
    public MethodsAndImports generateMethodAndImports() {
        ...
        Method method1 = new Method("updateByPrimaryKey"); //$NON-NLS-1$
        ...
        method1.addBodyLines(fragmentGenerator.getSetEqualLines(introspectedTable.getNonPrimaryKeyColumns(),
        ...
        Method method2 = new Method("updateByPrimaryKey"); //$NON-NLS-1$
        ...
        method2.addBodyLine("return update(tableName, c ->"); //$NON-NLS-1$
        method2.addBodyLines(fragmentGenerator.getSetEqualLines(introspectedTable.getNonPrimaryKeyColumns(),
                "    c", "    ", false)); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        return MethodsAndImports.withMethods(methods)
                .withImports(imports)
                .build();
    }
