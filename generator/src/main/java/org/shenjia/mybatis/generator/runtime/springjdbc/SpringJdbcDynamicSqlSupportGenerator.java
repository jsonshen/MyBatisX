...
public class SpringJdbcDynamicSqlSupportGenerator {
    private IntrospectedTable introspectedTable;
    private CommentGenerator commentGenerator;
    private List<String> warnings;

    private SpringJdbcDynamicSqlSupportGenerator() {
        super();
    }
    ...
    public static SpringJdbcDynamicSqlSupportGenerator of(IntrospectedTable introspectedTable,
            CommentGenerator commentGenerator, List<String> warnings) {
        SpringJdbcDynamicSqlSupportGenerator generator = new SpringJdbcDynamicSqlSupportGenerator();
