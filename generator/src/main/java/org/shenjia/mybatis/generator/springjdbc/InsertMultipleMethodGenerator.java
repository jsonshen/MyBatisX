...
public class InsertMultipleMethodGenerator extends AbstractMethodGenerator {
	...
	public MethodsAndImports generateMethodAndImports() {
		...
		imports.add(new FullyQualifiedJavaType("java.util.Collection"));
		...
		method.addParameter(new Parameter(new FullyQualifiedJavaType("Collection<"+ recordType.getShortName() + ">"), "records"));
